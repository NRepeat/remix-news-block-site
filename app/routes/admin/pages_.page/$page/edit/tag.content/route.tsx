...
import {additionalContentValidator} from '~/components/AdditionalTagsContentWidget/Form/Form';
...
export async function action({params, request}: ActionFunctionArgs) {
  try {
    ...
    const {quantity, type, id} = validatedFormData.data;
    await updateElement({content: JSON.stringify({type, quantity}), id, slug});
