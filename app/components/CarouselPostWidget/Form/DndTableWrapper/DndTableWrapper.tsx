...
type DndTableWrapper = {
  ...
  setSelectedPosts: React.Dispatch<
    React.SetStateAction<SerializeFrom<GetAllPostsType>>
  >;
};

const DndTableWrapper: FC<DndTableWrapper> = ({
  children,
  data,
  setSelectedPosts,
}) => {
  const [newDataPosition, setDataPosition] =
    useState<SerializeFrom<GetAllPostsType> | null>();
