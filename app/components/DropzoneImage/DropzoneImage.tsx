...
export const mediaUrlValidator = withZod(
  z.object({
    url: zfd.text(),
    type: zfd.text(),
  })
...
const MediaForm = ({action, type, label}: MediaFormType) => {
  return (
    <div className="flex w-full flex-col  ">
      <ValidatedForm
        className={'flex  w-ful flex-col items-start gap-2  pb-4'}
      ...
      <ValidatedForm
        className="flex  w-ful flex-col gap-2 items-start border-t-2  border-b-2 pb-2 "
